...
# Expt 15:Numpy signal processing-Blurring an image with a Gaussian filter 
# Class: III Year ECE - C 
# Course: 18ECE201J – Python and Scientific Python 
# Student Name and Reg Number: Anirudh Narayanan(RA1811004010147) 
import numpy as np 
import pylab 
...
for i in range(nsq):  place_square() 
pylab.imshow(image) 
pylab.show() 
